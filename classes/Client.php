...
class ClientCore extends ObjectModel
{
	public $id;
	...
	protected function getClientAddress()
	{
		...
		return Db::getInstance(_PS_USE_SQL_SLAVE_)->getValue('SELECT `id_address` FROM '._DB_PREFIX_.'address WHERE `id_client` = '.(int)$this->id);
	}
