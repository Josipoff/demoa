...
class DisableProductUpdate extends Module
{
  public function __construct()
  {
    $this->name = 'disableproductupdate';
    ...
    $this->displayName = $this->l('Disable Product Update');
    $this->description = $this->l('Update Store Product Availablity Information.');
...
public function getContent()
{
    ...
    if (Tools::isSubmit('submit'.$this->name))
    {
        ...
        else
        {
            ...
            Configuration::updateValue('PRODUCTDISABLEUPDATE_STATUS', '0');
            return $this->display(__FILE__,'disableproductupdate.tpl');
...
public function hookActionAdminControllerSetMedia($params)
{
    ...
    {
        $this->context->controller->addJS($this->_path.'/js/disableproductupdate.js');
    }
...
public function displayForm()
{
    ...
    $fields_form[0]['form'] = array(
        'legend' => array(
            'title' => $this->l('Product Disable Update'),
        ),
        'input' => array(
            array(
                'type' => 'text',
