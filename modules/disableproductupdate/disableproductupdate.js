...
$(document).ready(function()
{
	...
	{
		type: 'GET',
		url: '/pfizer/modules/disableproductupdate/disableProgressStatus.php',
		dataType: 'json',
		...
		success: function(result)
		{
                    ...
                    switch(result){
                        case 0:
                            instruction +='Starting Product Availability Update<br />';
                            break;
                        case 100:
                            instruction +='Product Availability Updates Completed<br />';
                            break;
                    }
...
function updateProduct(params_plus)
{
	...
	{
		type: 'GET',
		url: '/pfizer/webservice/disableProduct.php',
		dataType: 'json',
		cache: false, // @todo see a way to use cache and to add a timestamps parameter to refresh cache each 10 minutes for example
		success: function(result)
		{
