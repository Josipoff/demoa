...
{if $disable_upload_form=='0'}
    ...
    <script type="text/javascript">
	//var _validFileExtensions = [{/literal}{foreach from=$extensions item=ext name=loop}".{$ext}"{if !$smarty.foreach.loop.last}, {/if}{/foreach}{literal}+', '+".pdf"];

var _validFileExtensions = [".esp", ".cdr", ".jpg", ".png", ".tif", ".pdf", ".gif"];
