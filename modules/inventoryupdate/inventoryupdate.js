...
$(document).ready(function()
{
	...
	{
		type: 'GET',
		url: '/pfizer/modules/inventoryupdate/inventoryProgressStatus.php',
		dataType: 'json',
		...
		success: function(result)
		{
                    ...
                    switch(result){
                        case 0:
                            instruction +='Starting Product Inventory Update<br />';
                            break;
                        case 100:
                            instruction +='Product Inventory Updates Completed<br />';
                            break;
                    }
...
function updateProduct(params_plus)
{
	...
	{
		type: 'GET',
		url: '/pfizer/webservice/Inventory.php',
		dataType: 'json',
		cache: false, // @todo see a way to use cache and to add a timestamps parameter to refresh cache each 10 minutes for example
		success: function(result)
		{
