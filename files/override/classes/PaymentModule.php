                                                             ...
                                                             if ($row > 2){
                                                                ...
                                                                if($i==1){
                                                                    ...
                                                                    foreach($col1_info as $col1){
                                                                        $customization_text .='<tr id="product_'.$product['id_product'].'_'.$product['id_product_attribute'].'_'.$id_customization.'_'.$product['id_address_delivery'].'"'.
								'class="product_customization_for_'.$product['id_product'].'_'.$product['id_product_attribute'].'_'.$product['id_address_delivery'];
                                                                        if ($odd)
