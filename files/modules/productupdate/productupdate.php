...
class ProductUpdate extends Module
{
  public function __construct()
  {
    ...
    $this->displayName = $this->l('Product Update');
    $this->description = $this->l('Update Store Product Information.');
...
public function hookActionAdminControllerSetMedia($params)
{
    ...
    {
        $this->context->controller->addJS($this->_path.'/js/productupdate.js');
    }
