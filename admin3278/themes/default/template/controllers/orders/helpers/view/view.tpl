...
{block name="override_tpl"}
	...
	var admin_order_tab_link = "{$link->getAdminLink('AdminOrders')|addslashes}";
        ...
        var profitMargin = {$profit_margin};
		...
		<div class="col-lg-7">
			<div class="panel">
				...
				<div class="well hidden-print">
					...
					{/if}
					&nbsp;
                                        <p><br /><strong class="dark">{l s='In-Hand Date'}</strong> 
                                            <span class="in_hand_show color-myaccount">{dateFormat date=$order->date_in_hand full=0}</span>
                    ...
                    <span class="in_hand_edit" style="display:none;">
                              <input class="form-control" type="text" name="date_in_hand" id="date_in_hand"
                                                        value="{dateFormat date=$order->date_in_hand full=0}">
                              <input type="hidden" name="id_order" value="{$order->id}" />
                            </button>
                            <button type="submit" class="btn btn-default" name="submitInHandDate">
                                    {l s='Update'}
                            </button>
                    </span>
                    <button href="#" class="edit_in_hand_date">
                            <i class="icon-pencil"></i>
                            {l s='Edit'}
                    </button>
                    <button href="#" class="cancel_in_hand_date" style="display: none;">
                            <i class="icon-remove"></i>
                            {l s='Cancel'}
                    </button>
            </form>
	...
	<script type="text/javascript">
		...
		$('#tabAddresses').click(function(){
			...
			invoice_map.setCenter(c);
                ...
                var admin_order_url = "&vieworder&id_order={$order->id|intval}&id_order_invoice={if $line.id_order_invoice}{$line.id_order_invoice|intval}{else}0{/if}&id_carrier={if $line.id_carrier}{$line.id_carrier|escape:'html':'UTF-8'}{else}0{/if}";
