...
<tr id="new_product" style="display:none">
	...
	<td style="display:none;">
		...
		<button type="button" class="btn btn-default" id="submitAddProduct" disabled="disabled">
            ...
            <tr>
                <td colspan="7">
                <div id="add_product_product_decoration_area" class="form-group" style="display: none;">
			<label>{l s='Decoration'}</label>
			<div id="add_product_product_decoration_id"></select>
                        </div></td>
            </tr></table></td>
</tr>
