		...
		<div class="col-lg-12">
			<div class="form-group">
				...
				<div class="col-lg-9">
					...
					<div class="checkbox">
						<label for="web_service">
							<input type="checkbox" name="web_service" disabled="disabled" id="web_service" value="1" {if $product->web_service}checked="checked"{/if} >
							{l s='Product Added By Webservice'}</label>
					</div>
				</div>
			</div>
			<div class="form-group">
