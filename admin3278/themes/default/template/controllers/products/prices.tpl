...
<div id="product-prices" class="panel product-tab">
	...
	<div class="form-group">
		...
		<div class="input-group col-lg-2">
            ...
            <div class="form-group">
		<div class="col-lg-1"><span class="pull-right">{include file="controllers/products/multishop/checkbox.tpl" field="price" type="price"}</span></div>
		<label class="control-label col-lg-2" for="profit_margin">
			<span class="label-tooltip" data-toggle="tooltip" title="{l s='Mention profit margin for individual product. This will override profit margin set in website settings if dynamic pricing is enabled'}">{l s='Profit Margin'}</span>
		</label>
		<div class="input-group col-lg-2">
			<input size="11" maxlength="14" id="profit_margin" name="profit_margin" type="text" value="{$product->profit_margin|string_format:'%.6f'}" />
		</div>
	</div>
	<div class="form-group">
