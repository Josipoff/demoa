...
class CartControllerCore extends FrontController
{
	...
	public function init()
	{
		...
		$this->decoration = Tools::getValue('decoration');
	}
		...
		if (!$this->errors && $mode == 'add')
		{
			...
			if (!$this->errors)
			{
				$cart_rules = $this->context->cart->getCartRules();
                                $update_quantity = $this->context->cart->updateQty($this->decoration,$this->qty, $this->id_product, $this->id_product_attribute, $this->customization_id, Tools::getValue('op', 'up'), $this->id_address_delivery);
