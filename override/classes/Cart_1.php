...
class CartCore extends ObjectModel
{
	...
	public function getProducts($refresh = false, $id_product = false, $id_country = null)
	{
		...
		// Build SELECT
		$sql->select('cp.`id_product_attribute`, cp.`id_product`, cp.`decoration`, cp.`quantity` AS cart_quantity, cp.id_shop, pl.`name`, p.`is_virtual`,
	...
	public function addCartRule($id_cart_rule)
	{
		...
		if ((int)$cartRule->gift_product)
			$this->updateQty(1, $cartRule->gift_product, $cartRule->gift_product_attribute, false, 'up', 0, null, false,$cartRule->decoration);

		return true;
	}

	public function containsProduct($id_product, $id_product_attribute = 0, $id_customization = 0, $id_address_delivery = 0,$decoration)
	{
	 ...
	 */
	public function updateQty($decoration,$quantity, $id_product, $id_product_attribute = null, $id_customization = false,
		$operator = 'up', $id_address_delivery = 0, Shop $shop = null, $auto_add_cart_rule = true)
	{
		...
		else
		{
			...
			$result = $this->containsProduct($id_product, $id_product_attribute, (int)$id_customization, (int)$id_address_delivery,$decoration);
