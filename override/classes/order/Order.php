...
class OrderCore extends ObjectModel
{
	...
	*/
	...
	public function getWsShippingNumber()
	{
        ...
        public function getOrderIDbyActivationLink($link)
	{
	...
	public function setWsShippingNumber($shipping_number)
	{
        ...
        public static function updateInhandDate($orderID, $inhanddate){
            return Db::getInstance()->execute('UPDATE `'._DB_PREFIX_.'orders` SET `date_in_hand` = "'.$inhanddate.'" WHERE `id_order` = '.(int)($orderID));
