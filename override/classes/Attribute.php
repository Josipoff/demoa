...
class AttributeCore extends ObjectModel
{
	...
	public static function getHigherPosition($id_attribute_group)
	{
        ...
        public static function getColorAttributeIdByValue($color)
	{
		...
		return (is_numeric($position)) ? $position : false;
          ...
          public static function getDecorationAttributeIdByValue($decoration)
	{
		$sql = 'SELECT * FROM `'._DB_PREFIX_.'attribute_lang`
