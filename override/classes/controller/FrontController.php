...
class FrontControllerCore extends Controller
{
		...
		if (!$this->useMobileTheme())
		{
			...
			$this->context->smarty->assign(array(
				'HOOK_HEADER' => Hook::exec('displayHeader'),
                                'HOOK_footerParters' => Hook::exec('footerPartners'),
                                'HOOK_displayProductcustomquote' => Hook::exec('displayProductcustomquote'),
                                'HOOK_displayProductcustomquote' => Hook::exec('displayProductcustomquote'),
                                'HOOK_productFileContent' => Hook::exec('displayconverttopdf'),
                                'HOOK_productFile' => Hook::exec('productFile'),
                                'HOOK_displayTopinfo' => Hook::exec('displayTopinfo'),
                                'HOOK_displayFooterpartners' => Hook::exec('displayFooterpartners'),
	...
	public function displayHeader($display = true)
	{
        ...
        $this->context->smarty->assign(array(
			...
			'HOOK_TOP' => Hook::exec('displayTop'),
                        'HOOK_displayTopinfo' => Hook::exec('displayTopinfo'),
                        'HOOK_footerPartners' => Hook::exec('footerPartners'),
			'HOOK_displayProductcustomquote' => Hook::exec('displayProductcustomquote'),
                        'HOOK_productFileContent' => Hook::exec('displayconverttopdf'),
			'HOOK_productFileContent' => Hook::exec('productFileContent'),
                        'HOOK_productFile' => Hook::exec('productFile'),
                        'HOOK_LEFT_COLUMN' => ($this->display_column_left ? Hook::exec('displayLeftColumn') : ''),
                        'HOOK_RIGHT_COLUMN' => ($this->display_column_right ? Hook::exec('displayRightColumn', array('cart' => $this->context->cart)) : ''),
