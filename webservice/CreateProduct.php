...
$product_xml->ItemNumber='ES13033';
$product_xml->Brand='Promoline';
$product_xml->SKU='ES13033PLAZ';
$product_xml->Color='Azul';
$product_xml->Category='Escritura';
$product_xml->SubCategory='Boligrafos Plasticos';
$product_xml->BasePrice='7.760000';
$product_xml->LowestPrice='';
...
function save_product_combination($ProductId,$itemNumber,$list, $decoration,$color_name){
	global $webService,$webservice_exi,$product_xml, $count;
